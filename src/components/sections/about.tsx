    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24 relative z-10">
        <div className="flex flex-col items-center gap-12">
          <div className="space-y-8 text-white text-center max-w-3xl">
            ...
            <div className="space-y-6 text-left text-gray-200 md:text-lg/relaxed">
              ...
              <h4 className="font-headline text-xl font-semibold pt-4">Stage 2 – Diving Deeper into SOLIDWORKS</h4>
              ...
              <h4 className="font-headline text-xl font-semibold pt-4">Stage 3 – Automating Key Projects for Industry Employers</h4>
              ...
              <h4 className="font-headline text-xl font-semibold pt-4">Stage 4 – Professional Automation Engineering</h4>
              ...
              <h4 className="font-headline text-xl font-semibold pt-4">Stage 5 – Launching My Own CAD Automation Consultancy</h4>
              ...
              <h4 className="font-headline text-xl font-semibold pt-4">Mission</h4>
